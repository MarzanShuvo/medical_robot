...
Encoder encoder_fright(35, 34); //pin is changed from original (35, 34)
Encoder encoder_bleft(32, 33);
Encoder encoder_bright(31, 30); //pin is changed from original (31, 30)
...
const uint8_t LB_BACK = 26;
const uint8_t LB_FORW = 27;

const uint8_t RB_BACK = 28; //pin was interchanged RB_BACK = 28// RB_FORW = 29
